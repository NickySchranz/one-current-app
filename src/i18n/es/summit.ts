/**
 * Summit-theme copy (Spain). Keys are the theme's own English strings — the
 * values THEME_COPY (src/ui/theme-copy.ts) remaps to while summit is active.
...
export const summit: Record<string, string> = {
  ...
  "solid = active · curved back = integrated · thicker = louder · coiled ✓ = decided today":
    "sólida = activa · curva de vuelta = integrada · más gruesa = suena más fuerte · ✓ recogida = decidido hoy",
  ...
  "When something begins pulling part of your attention away from the present, add it as a rope with the + button. You can integrate it when it has given you what it carries.":
    "Cuando algo empiece a llevarse parte de tu atención del presente, añádelo como una cuerda con el botón +. Puedes integrarla cuando te haya dado lo que trae.",
  ...
  "{title} is currently the loudest rope.": "{title} es ahora la cuerda que suena más fuerte.",
  ...
  "One rope has been integrated and remains part of your history.":
    "Una cuerda ha sido integrada y sigue siendo parte de tu historia.",
  "{n} ropes have been integrated and remain part of your history.":
    "{n} cuerdas han sido integradas y siguen siendo parte de tu historia.",
  "Rope reaching today": "Cuerda que llega a hoy",
  "Currently activated rope": "Cuerda activada ahora mismo",
  ...
  "How loud is this rope right now?": "¿Cómo de fuerte suena esta cuerda ahora mismo?",
  "Understand this rope": "Comprender esta cuerda",
  ...
  "No integrated ropes yet.": "Aún no hay cuerdas integradas.",
  "When you integrate a rope it appears here — tap to revisit it on the timeline.":
    "Cuando integras una cuerda aparece aquí — tócala para volver a verla en la línea de tiempo.",
  ...
  "This rope will be gone from the app — completely. No line, no history. Only the lesson stays.":
    "Esta cuerda desaparecerá de la aplicación — del todo. Sin línea, sin historial. Solo queda la lección.",
  "Cut the rope": "Corta la cuerda",
  "The lesson you carry up the mountain": "La lección que llevas montaña arriba",
  "The drop takes the weight. You keep this.": "La caída se lleva el peso. Tú te quedas con esto.",
};
