...
export const shareFields: Record<string, string> = {
  ...
  "What your psychologist will see": "Lo que verá tu psicólogo",
  "Opened {opened} · Integrated {integrated}": "Abiertos {opened} · Integrados {integrated}",
  "how loud it was at the start of the window, in a word": "qué tan fuerte estaba al inicio del periodo, en una palabra",
  "how loud it is now, in a word": "qué tan fuerte está ahora, en una palabra",
};
