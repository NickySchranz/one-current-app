...
export const paywall: Record<string, string> = {
  ...
  "The five plain looks are always free. The creature themes — where every open thread becomes a small companion — come with One Current Pro.": "Los cinco aspectos sencillos son gratuitos siempre. Los temas con criaturas — donde cada hilo abierto se vuelve un compañerito — vienen con One Current Pro.",
