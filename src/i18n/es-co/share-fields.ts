/**
 * The "what leaves the app" list, Colombian Spanish. These strings live in
...
export const shareFields: Record<string, string> = {
  // about each thread
  "the name you gave the thread": "el nombre que le pusiste al hilo",
  "anything you wrote to describe it": "lo que hayás escrito para describirlo",
  "what kind of thread it is": "qué clase de hilo es",
  "where it points (past, future, a person, your body…)":
    "para dónde apunta (pasado, futuro, una persona, tu cuerpo…)",
  ...
  "what you believe now, in your words": "lo que creés ahora, con tus palabras",
  "what you marked as still true and coming with you":
    "lo que marcaste como todavía cierto y que se viene con vos",
  ...
  // about what happened
  "the words you gave a moment or a step": "las palabras que le pusiste a un momento o a un paso",
  "anything you wrote about a moment": "lo que hayás escrito sobre un momento",
  "what kind of moment it was": "qué clase de momento fue",
  "how much you said a moment landed": "cuánto dijiste que te llegó un momento",
  "a belief a moment added, in your words":
    "una creencia que sumó un momento, con tus palabras",
  "whether a moment made the thread stronger, lighter or different":
    "si un momento dejó el hilo más fuerte, más liviano o distinto",
  ...
  "what stayed true": "lo que siguió siendo cierto",
  "beliefs that aged out": "creencias que se vencieron",
  ...
  "what kind of record each one is": "qué clase de registro es cada uno",
